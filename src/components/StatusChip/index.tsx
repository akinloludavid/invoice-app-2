...
export const StatusChip = ({ status = "paid" }: IStatus) => {
  ...
  if (status === "pending") {
    return (
      <Flex
        ...
        gap={["8px"]}
      >
        <Box w="8px" h="8px" borderRadius={"full"} bgColor={pendingColor}></Box>
        <Text
          color={pendingColor}
          zIndex="9999"
          fontSize="12px"
    ...
    return (
      <Flex
        ...
        gap={["8px"]}
      >
        <Box w="8px" h="8px" borderRadius={"full"} bgColor={paidColor}></Box>
        <Text
          color={paidColor}
          fontSize="12px"
          fontWeight={"700"}
    ...
    return (
      <Flex
        ...
        gap={["8px"]}
      >
        <Box w="8px" h="8px" borderRadius={"full"} bgColor={draftColor}></Box>
        <Text
          opacity="1"
          color={draftColor}
          fontSize="12px"
